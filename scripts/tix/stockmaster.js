// lightly adjusted from:
// https://github.com/alainbryden/bitburner-scripts/blob/main/stockmaster.js
...
const argsSchema = [
    ...
    ['fracH', 0.05], // Fraction of assets to retain as cash in hand when buying
